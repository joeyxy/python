...
def check_code():
    ...
    fields = [('url','http://www.china-pub.com/member/register/imgchk/validatecode.asp'),('service', 'OcrKingForCaptcha'),('language','eng'),('charset','11'),('apiKey', key),('type','http://www.china-pub.com/member/register/imgchk/validatecode.asp')]
