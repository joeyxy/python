...
def downloadImg():
    ...
    pic_url = "https://butian.360.cn/index/getcaptcha2?"
...
def check_code():
    ...
    fields = [('url','https://butian.360.cn/index/getcaptcha2?'),('service', 'OcrKingForCaptcha'),('language','eng'),('charset','4'),('apiKey', key),('type','https://butian.360.cn/index/getcaptcha2?')]
