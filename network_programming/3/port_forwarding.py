...
REMOTE_SERVER_HOST = 'www.163.com'
BUFSIZE = 4096


class PortFowarder(asyncore.dispatcher):
...
if __name__ == '__main__':
	...
	print "Staring port forwarding local %s:%s => remote %s:%s " % (local_host,local_port,remote_host,remote_port)
	PortFowarder(local_host, local_port, remote_host, remote_port)
	asyncore.loop()